...
- It must be used on a Bootstrap [nav component]({{ .Site.BaseURL }}/docs/{{ .Site.Params.docs_version }}/components/navs/) or [list group]({{ .Site.BaseURL }}/docs/{{ .Site.Params.docs_version }}/components/list-group/).
